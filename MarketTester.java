...
public class MarketTester{
    public static void main(String[] args){
        ...
        try{
            ...
            myBasket.add(new Jam("jam",3,400));
            myBasket.add(new SeasonalFruit("hellofruit",1,500));
...
//            System.out.println(cust.getBalance());
            ...
            cust.addToBasket(new Fruit("Random fruit",1.1,340));
            cust.addToBasket(new Jam("jam",3,400));
            cust.addToBasket(new SeasonalFruit("hellofruit",1,500));
            //cust.checkOut();
